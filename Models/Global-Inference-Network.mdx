...
- **Mode 2: Global hybrid deployment.** Attach your private clusters to the Global Inference Network through the Beamlit operator, and federate multi-region deployments behind our global networking system. Read our guide on XXX
