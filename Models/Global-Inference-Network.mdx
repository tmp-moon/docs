...
- **Mode 2: Global hybrid deployment.** *(Available soon!)* Attach your private clusters to the Global Inference Network and federate multi-region deployments behind our global networking system. Deployment policies allow you to configure where and how models are deployed. Read our guide on how to attach locations on your Global Inference Network.
